        ...
        <div className="flex items-center space-x-6">
            ...
            icon={
              ...
              >
                <path
                  ...
                  stroke="currentColor"
                  strokeWidth="1.5"
                  d="M1 10.424c0-1.552 0-2.328.314-3.01.313-.682.902-1.187 2.08-2.196l1.143-.98C6.667 2.413 7.732 1.5 9 1.5c1.268 0 2.333.913 4.463 2.738l1.142.98c1.179 1.01 1.768 1.514 2.081 2.196.314.682.314 1.458.314 3.01v4.846c0 2.155 0 3.233-.67 3.902-.669.67-1.746.67-3.901.67H5.57c-2.155 0-3.232 0-3.902-.67C1 18.502 1 17.425 1 15.27v-4.846z"
                />
                <path
                  className={
                    activeNav === "home" ? "text-blue-600" : "text-gray-600"
                  ...
                  strokeWidth="1.5"
                  d="M11.857 19.841v-5.857a1 1 0 00-1-1H7.143a1 1 0 00-1 1v5.857"
                />
              </svg>
            }
          />
          ...
          <NavIcon
            ...
            icon={
              ...
              >
                <path
                  fill={activeNav === "friends" ? "#2563eb" : "#666"}
                  fillOpacity=".6"
                  fillRule="evenodd"
          ...
          <NavIcon
            ...
            icon={
              <div className="relative">
                ...
                >
                  <path
                    fill={activeNav === "notifications" ? "#2563eb" : "#666"}
                    fillOpacity=".6"
                    fillRule="evenodd"
          ...
          <NavIcon
            ...
            icon={
              <div className="relative">
                ...
                >
                  <path
                    fill={activeNav === "chat" ? "#2563eb" : "#666"}
                    fillOpacity=".6"
                    fillRule="evenodd"
...
// NavIcon Component
const NavIcon = ({ href, isActive, onClick, icon }) => {
  return (
    <a
      href={href}
      onClick={onClick}
